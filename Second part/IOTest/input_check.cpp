...
bool check_array_for_correct_numbers(int** array, size_t size, ostream& output)
{
    ...
    for(size_t i = 0; i < size; i++)
    {
        for(size_t j = 0; j < size; j++)
        {
            ...
            {
                get_error(UNKNOWN_SYMBOL, output);
                return true;
            }
...
bool check_array_for_holes(int** array, size_t size, ostream& output)
{
...
bool check_array_for_single_figure(int** array, size_t size, ostream& output)
{
...
bool check_array_performance(int** array, size_t size, ostream& output)
{
    bool correct_number_check = true;
    bool holes_check = true;
    bool single_figure_check = true;
    
    correct_number_check = check_array_for_correct_numbers(array, size, output);
    ...
    single_figure_check = check_array_for_single_figure(array, size, output);
    ...
    holes_check = check_array_for_holes(array, size, output);
