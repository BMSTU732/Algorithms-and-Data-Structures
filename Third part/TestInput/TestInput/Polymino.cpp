...
void Polymino::printArrayPerformance(ofstream& out)
{
    out << endl;
...
void Polymino::printGroupPerfomances(ofstream& out)
{
    for(int i = 0; i < group_performances_array.size(); i++)
    {
        out << group_performances_array[i] << endl;
    }
}

void Polymino::printPolyminoInfo(ofstream& out)
{
    out << endl << getPrimaryKey() << endl << "Array performance:";
    printArrayPerformance(out);
    
    out << endl << "Group performances:" << endl;
    printGroupPerfomances(out);
}
